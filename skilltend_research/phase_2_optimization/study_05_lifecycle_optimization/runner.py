...
Usage::
    ...
    python -m phase_2_optimization.study_05_lifecycle_optimization.runner --dry-run
"""
...
from phase_2_optimization.study_05_lifecycle_optimization.lifecycle_predictor import (
    LifecyclePredictor,
    SkillSnapshot,
    snapshot_from_files,
)
