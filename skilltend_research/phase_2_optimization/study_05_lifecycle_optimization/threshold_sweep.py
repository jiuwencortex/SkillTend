...
Usage::
    ...
    from phase_2_optimization.study_05_lifecycle_optimization.simulate_usage import simulate_library_usage
    from phase_2_optimization.study_05_lifecycle_optimization.threshold_sweep import (
        sweep_thresholds,
        best_threshold_pair,
        format_sweep_table,
    )
...
from phase_2_optimization.study_05_lifecycle_optimization.simulate_usage import SkillUsageProfile
...
def survival_informed_recommendation(
    ...
    """
    from phase_2_optimization.study_05_lifecycle_optimization.simulate_usage import survival_analysis
