...
Usage::
    ...
    # Quick smoke test
    python -m phase_2_optimization.study_02_trigger_policy.runner --dry-run --sessions-per-config 2
"""
...
from phase_2_optimization.study_02_trigger_policy.adaptive_trigger import AdaptiveTrigger
from phase_2_optimization.study_02_trigger_policy.sweep import run_sweep
...
async def _main_async(args: argparse.Namespace) -> None:
    ...
    # Phase C: Analyze
    print("\nPhase C: Analysis")
    from phase_2_optimization.study_02_trigger_policy.analyze import analyze
