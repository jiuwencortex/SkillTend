...
Usage::
    ...
    python -m phase_3_refinement.study_06_prompt_sensitivity.runner --dry-run --sessions 3
"""
...
from phase_3_refinement.study_06_prompt_sensitivity.ablations import (
    ALL_VARIANTS,
    CONTEXT_STRATEGIES,
    ContextStrategy,
    PromptVariant,
...
async def _main_async(args: argparse.Namespace) -> None:
    ...
    from phase_3_refinement.study_06_prompt_sensitivity.ablations import FULL_PROMPT
